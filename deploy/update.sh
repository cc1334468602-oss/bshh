#!/usr/bin/env bash
# ==========================================================
# bshh 前台 H5 —— 更新部署（拉取最新代码并零停机重载）
# 用法：cd /var/www/bshh && bash deploy/update.sh
# ==========================================================
set -e
...
echo ""
echo "[1/4] 拉取最新代码"
TARBALL="https://codeload.github.com/cc1334468602-oss/bshh/tar.gz/refs/heads/main"
TMPD=$(mktemp -d)
...
REMOTE_SHA=$(timeout 10 git ls-remote https://github.com/cc1334468602-oss/bshh main 2>/dev/null | awk '{print $1}') || true
